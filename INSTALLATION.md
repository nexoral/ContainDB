...
wget https://github.com/nexoral/ContainDB/releases/download/v5.15.36-stable/containDB_5.15.36-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_5.15.36-stable_amd64.deb
