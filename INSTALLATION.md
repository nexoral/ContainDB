...
wget https://github.com/nexoral/ContainDB/releases/download/v7.19.42-stable/containDB_7.19.42-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_7.19.42-stable_amd64.deb
